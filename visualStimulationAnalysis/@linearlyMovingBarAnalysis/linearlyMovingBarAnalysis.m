classdef linearlyMovingBarAnalysis < VStimAnalysis
    ...
    methods (Hidden)
        ...
        function [obj] = linearlyMovingBarAnalysis(dataObj,params)
    ...
    methods
        ...
        function results = ResponseWindow(obj, params)
            ...
            A = [stimOn' obj.VST.directions' obj.VST.speeds' obj.VST.offsets'];
            [C indexS] = sortrows(A,[2 3 4]);

            B = [stimOff' obj.VST.directions' obj.VST.speeds' obj.VST.offsets'];
            ...
            for s = 1:x %iterate among unique speeds
                ...
                [C indexS] = sortrows(At,[2 3 4]); %2 6 3 4 5
            ...
            colNames = {'Resp','MaxWinTrial','MaxWinBin','RespSubsBaseline','Directions','Speeds','Offsets'};
