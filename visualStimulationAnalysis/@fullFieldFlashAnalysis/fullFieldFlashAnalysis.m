classdef fullFieldFlashAnalysis < VStimAnalysis
    ...
    methods
        ...
        function results = ResponseWindow(obj,params)
            ...
            NeuronVals = zeros(nN,nT/(trialDivision/2),4); %Each neuron, which has a matrix where the first column is maxVal of bins, 2nd and 3rd position of window in matrix...
            % 4th Z-score.
